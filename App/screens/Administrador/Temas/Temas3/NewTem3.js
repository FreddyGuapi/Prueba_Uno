...
import { createQuestion3 } from '../../../../utils/database'
import { launchImageLibrary } from 'react-native-image-picker'
import storage from '@react-native-firebase/storage';

const NewTem3 = ({ navigation }) => {
    ...
    const handleQuestionSave = async () => {
        ...
        if (imageUri != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo3/imagenes/${currentQuestionId}.jpg`,
            );
        ...
        if (imageQR != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo3/QR/${currentQuestionId}.jpg`,
            );
        ...
        await createQuestion3(currentQuestionId, {
            titulo: question,
