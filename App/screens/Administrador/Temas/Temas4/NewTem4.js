...
import { createQuestion4 } from '../../../../utils/database'
import { launchImageLibrary } from 'react-native-image-picker'
import storage from '@react-native-firebase/storage';

const NewTem4 = ({ navigation }) => {
    ...
    const handleQuestionSave = async () => {
        ...
        if (imageUri != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo4/imagenes/${currentQuestionId}.jpg`,
            );
        ...
        if (imageQR != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo4/QR/${currentQuestionId}.jpg`,
            );
        ...
        await createQuestion4(currentQuestionId, {
            titulo: question,
