...
import { createQuestion2 } from '../../../../utils/database'
import { launchImageLibrary } from 'react-native-image-picker'
import storage from '@react-native-firebase/storage';

const NewTem2 = ({ navigation }) => {
    ...
    const handleQuestionSave = async () => {
        ...
        if (imageUri != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo2/imagenes/${currentQuestionId}.jpg`,
            );
        ...
        if (imageQR != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo2/QR/${currentQuestionId}.jpg`,
            );
        ...
        await createQuestion2(currentQuestionId, {
            titulo: question,
