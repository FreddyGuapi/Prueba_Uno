        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    text: "Si",
                    onPress: () => {
                        firestore().collection('Capitulo5').doc(item.key).delete().then(() => {
                            Alert.alert(
                                "Eliminación Exitosa",
        ...
        if (titulo == '' || descripcion == '') {
            ...
            if (imagen != '') {
                const reference = storage().ref(
                    `/Capitulos/Capitulo5/imagenes/${editDoc}.jpg`,
                );
            ...
            if (QR != '') {
                const reference = storage().ref(
                    `/Capitulos/Capitulo5/QR/${editDoc}.jpg`,
                );
            ...
            try {
                firestore().collection('Capitulo5').doc(editDoc).update({
                    titulo,
                    descripcion,
                    imagen: imageUrl,
                    QR: imageQUrl,
