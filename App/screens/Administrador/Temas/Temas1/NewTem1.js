    ...
    const handleQuestionSave = async () => {
        ...
        if (imageUri != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo1/imagenes/${currentQuestionId}.jpg`,
            );
        ...
        if (imageQR != '') {
            const reference = storage().ref(
                `/Capitulos/Capitulo1/QR/${currentQuestionId}.jpg`,
            );
        ...
        await createQuestion(currentQuestionId, {
            titulo: question,
